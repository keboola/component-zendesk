...
EMAIL = "zdenek.srotyr@keboola.com"
TOKEN = "mjsRIp1qIfp6BpQZKs3n9OeJMjiUL82m7KgDGmry"
...
def incremental_load_all_default() -> Any:
    ...
    info = pipeline.run(data_support.with_resources("ticket_comments"))
    return info
...
if __name__ == "__main__":
    ...
    os.environ["SOURCES__CREDENTIALS__SUBDOMAIN"] = "keboolasupport"
    os.environ["SOURCES__CREDENTIALS__EMAIL"] = EMAIL
    os.environ["SOURCES__CREDENTIALS__TOKEN"] = TOKEN
