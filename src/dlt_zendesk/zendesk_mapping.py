...
views = {
    ...
    TableMapping("tickets_metrics", """
        ...
        SELECT
            ...
            json(metric_set).reply_time_in_minutes.calendar AS reply_time_in_minutes_calendar,
            json(metric_set).reply_time_in_minutes.business AS reply_time_in_minutes_business,
